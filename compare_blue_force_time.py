...
def main():
    ...
    for f, c, l in zip(filelist, colorlist, legend_list):
        ...
        plt.plot(averaged_correct_time / 3600, averaged_blues_force, linestyle='solid',
    ...
    # plt.yscale('log')
    plt.title(f'Moving average of remaining effective force of blues, window={window}')
    plt.grid(which="both")
    plt.minorticks_on()
    plt.legend()
